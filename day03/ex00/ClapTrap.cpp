...
ClapTrap::ClapTrap(std::string str) :  _Name(str), _HitPoint(10), _EnergyPoint(10), _AttackDamage(0) {
    std::cout <<  BGRN << "call default constructor" << std::endl << reset;
}

ClapTrap::ClapTrap(const ClapTrap &obj) {
    *this = obj;
    std::cout << BGRN << "call copy constructor" << std::endl << reset;
}

ClapTrap::~ClapTrap(void) {
    std::cout << BRED << "call destructor" << std::endl << reset;
}

/* ------------------------------------------------------------------------------ */

ClapTrap &ClapTrap::operator=(const ClapTrap &obj) {
    std::cout << BGRN << "calls equalizer operator overload" << std::endl << reset;
    _Name = obj._Name;
